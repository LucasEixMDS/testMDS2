...
const Fichette = ({ formation }) => {
  ...
  return (
    <div className="modaleFichette">
      <span className="h2" style={colorStyle}>{formation.header.title}</span>
            ...
            <div className="containTextFichette">
                ...
                <div className="textFichette">
                    <p className="iconCont">{formation.fichette.lieu}</p>
                </div>
            </div>
            <div className="containTextFichette">
                <p style={colorStyle}><img src={Euro} alt="icon pour le prix un euro" /></p>
                <div className="textFichette">
                    <p className="iconCont">{formation.fichette.tarifs}</p>
                </div>
            </div>
            <div className="containTextFichette">
